import { Controller,Post,Get,Put,Delete,Param,Query,Body,Res,UseInterceptors} from '@nestjs/common';
import { UsersService } from './users.service';
import { CreateUserDto } from './dtos/user-create.dto';
import { GetUserByIdDto } from './dtos/user-id.dto';
import { GetUsersByEmail } from './dtos/users.dto';
import { UpdateUserDto } from './dtos/user-update.dto';
import { ResponseSerialization, Serialize } from 'src/interceptors/serialize.interceptor';
